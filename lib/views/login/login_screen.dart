                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        'Sign In',
                        style: FontSystem.KR32SB.copyWith(color: const Color(0xFF2A4ECA)),
      ...
      children: <Widget>[
        ...
        Obx(() => TextField(
              ...
              decoration: InputDecoration(
                labelText: "Email",
                labelStyle: FontSystem.KR16R.copyWith(color: const Color(0xFF7C8BA0)),
                ...
                focusedBorder: OutlineInputBorder(
                  ...
                  borderSide: BorderSide(
                    color: viewModel.isEmailFocused.value ? const Color(0xFF3461FD) : Colors.white,
                    width: 1,
                  ),
                ),
              ),
        ...
        Obx(() => TextField(
              ...
              decoration: InputDecoration(
                ...
                focusedBorder: OutlineInputBorder(
                  borderRadius: BorderRadius.circular(14),
                  borderSide: BorderSide(
                    color: viewModel.isPasswordFocused.value ? const Color(0xFF3461FD) : Colors.white,
                    width: 1,
                  ),
                ),
    ...
    return Column(
      children: <Widget>[
        ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            backgroundColor: const Color(0xFF567AF3),
            minimumSize: const Size(double.infinity, 60),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(14),
            ),
